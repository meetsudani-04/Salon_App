$(document).ready(function () {
  ...
  function check_all_validation() {
    ...
    var is_repeat_password_error = validationCheck("repeat_password");
    if (is_email_error || is_password_error || is_fname_error || is_lname_error || is_repeat_password_error) {
      return false;
    }
    return true;
  }
